...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/anapato/" htmlEscape="true "/>"><spring:message code="pato" /></a></li>
			</ol>
			<!-- end breadcrumb -->
	...
	<spring:url value="/resources/scripts/analisis/ana-pato.js" var="anaPato" />
	<script src="${anaPato}"></script>
