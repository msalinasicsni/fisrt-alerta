...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/anasex/" htmlEscape="true "/>"><spring:message code="sex" /></a></li>
			</ol>
			<!-- end breadcrumb -->
				...
				<div class="row">
					...
					<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="jarviswidget" id="wid-id-2">
							...
							<header>
								<span class="widget-icon"> <i class="fa fa-comments"></i> </span>
								<h2>Distribución por sexo absoluta</h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
					...
					<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="jarviswidget" id="wid-id-3">
							...
							<header>
								<span class="widget-icon"> <i class="fa fa-comments"></i> </span>
								<h2>Distribución por sexo proporcional</h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
					...
					<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						...
						<div class="jarviswidget" id="wid-id-4">
							...
							<header>
								<span class="widget-icon"> <i class="fa fa-comments"></i> </span>
								<h2>Distribución por sexo tasas</h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
								...
								<!-- widget content -->
								<div class="widget-body">
									<div id="pieChart3-title" align="center"></div>
	...
	<spring:url value="/resources/scripts/analisis/ana-sexo.js" var="anaSexo" />
	<script src="${anaSexo}"></script>
	...
	<spring:url value="/analisis/anasexdata/" var="sActionUrl"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	$("li.anasex").addClass("active");
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.anasex").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
