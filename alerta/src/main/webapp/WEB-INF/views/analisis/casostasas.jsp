...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/anapato/" htmlEscape="true "/>"><spring:message code="numandrate" /></a></li>
			</ol>
			<!-- end breadcrumb -->
	...
	<spring:url value="/resources/scripts/analisis/casos-tasas.js" var="casosTasas" />
	...
	<spring:url value="/analisis/casostasasdata/" var="sActionUrl"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	$("li.casostasas").addClass("active");
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.casostasas").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
