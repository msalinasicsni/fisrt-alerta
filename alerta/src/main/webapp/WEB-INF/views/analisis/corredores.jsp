...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/corredores/" htmlEscape="true "/>"><spring:message code="endemic" /></a></li>
			</ol>
			<!-- end breadcrumb -->
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget" id="wid-id-1">
							...
							<header>
								...
								<h2><spring:message code="endemic" /></h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
	...
	<spring:url value="/resources/scripts/analisis/corredores.js" var="razones" />
	...
	<spring:url value="/analisis/corredoresdata/" var="sActionUrl"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	$("li.corredores").addClass("active");
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.corredores").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
