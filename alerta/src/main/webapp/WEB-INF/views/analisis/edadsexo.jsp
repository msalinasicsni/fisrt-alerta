...
<div id="ribbon">
    ...
    <ol class="breadcrumb">
        <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home"/></a> <i
            ...
            <spring:message code="analysis"/> <i class="fa fa-angle-right"></i> <spring:message code="descriptive"/>
            <i class="fa fa-angle-right"></i> <a
                    href="<spring:url value="/analisis/agesex/" htmlEscape="true "/>"><spring:message
                    code="agesex"/></a></li>
    </ol>
    <!-- end breadcrumb -->
        ...
        <h1 class="page-title txt-color-blueDark">
            ...
            <spring:message code="analysis"/>
						<span> <i class="fa fa-angle-right"></i>  
							<spring:message code="descriptive"/>
						</span>
						<span> <i class="fa fa-angle-right"></i>  
							<spring:message code="agesex"/>
						</span>
        </h1>
    </div>
    <!-- end col -->
                    ...
                    <fieldset>
                            ...
                            <section>
                                <div class="input-group">
                                    ...
                                    <select data-placeholder="<spring:message code="act.select" /> <spring:message code="pato" />"
                                            name="codPato" id="codPato" class="select2">
                                        <option value=""></option>
                                        <c:forEach items="${patologias}" var="patologia">
                                            <option value="${patologia.codigo}">${patologia.codigo}
                        ...
                        <div class="row">
                            <section>
                                <div class="input-group">
                                    ...
                                    <select data-placeholder="<spring:message code="act.select" /> <spring:message code="level" />"
                                            name="codArea" id="codArea" class="select2">
                                        <option value=""></option>
                            ...
                            <section id="silais" hidden="hidden">
                                <div class="input-group">
                                    ...
                                    <select data-placeholder="<spring:message code="act.select" /> <spring:message code="silais" />"
                                            name="codSilaisAtencion" id="codSilaisAtencion" class="select2">
                                        <option value=""></option>
                        ...
                        <div class="row">
                            <section id="departamento" hidden="hidden">
                                <div class="input-group">
                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
                                    <select data-placeholder="<spring:message code="msg.select.depa" />"
                                            name="codDepartamento" id="codDepartamento" class="select2">
                                        <option value=""></option>
                        ...
                        <div class="row">
                            <section id="municipio" hidden="hidden">
                                <div class="input-group">
                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
                                    <select data-placeholder="<spring:message code="act.select" /> <spring:message code="muni" />"
                        ...
                        <div class="row">
                            <section id="unidad" hidden="hidden">
                                <div class="input-group">
                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
                                    <select data-placeholder="<spring:message code="act.select" /> <spring:message code="lbl.health.unit" />"
                                            name="codUnidadAtencion" id="codUnidadAtencion" class="select2">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </section>
                        ...
                        <!-- END ROW -->
                        <footer>
                            <button type="submit" id="view-report" class="btn btn-info"><i class="fa fa-refresh"></i>
