...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/indice/" htmlEscape="true "/>"><spring:message code="epiindex" /></a></li>
			</ol>
			<!-- end breadcrumb -->
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget" id="wid-id-1">
							...
							<header>
								...
								<h2><spring:message code="epiindex" /></h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
	...
	<spring:url value="/resources/scripts/analisis/indice.js" var="indices" />
	<script src="${indices}"></script>
	...
	<spring:url value="/analisis/indicedata/" var="sActionUrl"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.indice").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
