...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<spring:message code="analysis" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/analisis/series/" htmlEscape="true "/>"><spring:message code="series" /></a></li>
			</ol>
			<!-- end breadcrumb -->
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget" id="wid-id-1">
							...
							<header>
								...
								<h2><spring:message code="series" /></h2>				
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
	...
	<spring:url value="/resources/scripts/analisis/series.js" var="series" />
	<script src="${series}"></script>
	...
	<spring:url value="/analisis/seriesdata/" var="sActionUrl"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.series").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
