	...
	<div id="main" data-role="main">
		...
		<div id="content">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    <table id="dtDetalle" class="table table-striped table-bordered table-hover" style="width: 100%" data-width="100%">
                                        <thead>
                                        <tr>
                                            <th colspan="1" style="background-color: #3276b1"></th><th colspan="1" style="background-color: #3276b1"></th>
                                            <th colspan="3" style="text-align: center; background-color: #3276b1;" class="font-md txt-color-white"><spring:message code="lbl.ento.homes" /></th>
                                            <th colspan="3" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.block" /></th>
                                            <th colspan="3" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.tank" /></th>
                                            <th colspan="3" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.index" /></th>
                                            <th colspan="3" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.dates" /></th>
                                            <th colspan="1" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.no" /></th>
                                            <th colspan="1" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.no" /></th>
                                            <th colspan="1" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"><spring:message code="lbl.ento.no" /></th>
                                            <th colspan="1" style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"></th>
                                        </tr>
                                        <tr>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.no" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.locality" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.insp" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.posit" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.index" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.insp" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.posit" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.index" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.insp" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.posit" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.index" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.bretes" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.pupae" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.ipupae" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.abat" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.report" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.vent" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.abat" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.elimi" /></p></th>
                                            <th style="background-color: #3276b1"><p class="text-center font-sm txt-color-white"><spring:message code="lbl.ento.neutr" /></p></th>
                                            <th style="text-align: center; background-color: #3276b1" class="font-md txt-color-white"></th>
                                        </tr>
                                        </thead>
                                        <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="7" style="text-align: center; background-color: #86b4dd"></th>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
            ...
            <fieldset>
                ...
                <div class="row">
                    <section class="col col-sm-12 col-md-6 col-lg-4">
                        <label class="txt-color-blue font-md"><spring:message code="lbl.ento.no" /> <spring:message code="lbl.ento.abat" />
                        </label>
                        <div class="">
                            <label class="input"> <i class="icon-append fa fa-sort-numeric-desc"></i>
                    ...
                    <section class="col col-sm-12 col-md-6 col-lg-4">
                        <label class=" txt-color-blue font-md"><spring:message code="lbl.ento.no" /> <spring:message code="lbl.ento.elimi" />
                        </label>
                        <div class="">
                            <label class="input"> <i class="icon-append fa fa-sort-numeric-desc"></i>
                    ...
                    <section class="col col-sm-12 col-md-6 col-lg-4">
                        <label class="txt-color-blue font-md"><spring:message code="lbl.ento.no" /> <spring:message code="lbl.ento.neutr" />
                        </label>
                        <div class="">
                            <label class="input"> <i class="icon-append fa fa-sort-numeric-desc"></i>
