...
<!-- MAIN PANEL -->
		...
		<div id="ribbon">
            ...
            <ol class="breadcrumb">
                <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i>
                    <spring:message code="lbl.reports" /> <i class="fa fa-angle-right"></i> <spring:message code="menu.reports.home" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/reportesPorResidencia/area" htmlEscape="true "/>"><spring:message code="menu.report.by.area" /></a></li>
            </ol>
            <!-- end breadcrumb -->
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						...
						<span> <i class="fa fa-angle-right"></i>  
							<spring:message code="menu.report.by.area" />
						</span>
					</h1>
				</div>
				<!-- end col -->
                ...
                <article class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                    ...
                    <div class="jarviswidget" id="wid-id-4">
                        ...
                        <header>
                            ...
                            <h2><spring:message code="lbl.cases.distribution.weeks"/> </h2>
                        </header>
                        <!-- widget div-->
                        <div>
                            <!-- widget edit box -->
				...
				<div id="d1" class="row">
					...
					<article class="col-xs-12 col-sm-12 col-md-7 col-lg-12">
						...
						<div class="jarviswidget" id="wid-id-3">
							...
							<header>
								<span class="widget-icon"> <i class="fa fa-comments"></i> </span>
                                <h2><spring:message code="lbl.distribution.cases"/> </h2>
	...
	<spring:url value="/resources/scripts/reportes/area.js" var="areaJS" />
    ...
    <c:url var="sActionUrl" value="/reportesPorResidencia/dataArea"/>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var parametros = {sActionUrl: "${sActionUrl}",
                    ...
                    noData: "${noData}",
                    msgNoData: "${msgNoData}"};
            areaReport.init(parametros);
            SeleccionUnidadReporte.init(parametros);
            handleDatePickers("${pageContext.request.locale.language}");
            $("li.reportes").addClass("open");
            $("li.homearea").addClass("active");
            if("top"!=localStorage.getItem("sm-setmenu")){
                $("li.homearea").parents("ul").slideDown(200);
            }
		});
	</script>
	<!-- END JAVASCRIPTS -->
