...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<spring:message code="lbl.reports" /> <i class="fa fa-angle-right"></i> <spring:message code="menu.reports.home" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/reportesPorResidencia/porSemana" htmlEscape="true "/>"><spring:message code="menu.weekly.report" /></a></li>
			</ol>
			<!-- end breadcrumb -->
	...
	<spring:url value="/reportesPorResidencia/getDataPorSemana/" var="sActionUrl"/>
