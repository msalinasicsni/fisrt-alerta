...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<ol class="breadcrumb">
				...
				<spring:message code="lbl.reports" /> <i class="fa fa-angle-right"></i> <spring:message code="menu.reports.home" /> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/reportesPorResidencia/sinResultado" htmlEscape="true "/>"><spring:message code="menu.notifications.without.result" /></a></li>
			</ol>
			<!-- end breadcrumb -->
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						...
						<span> <i class="fa fa-angle-right"></i>
							<spring:message code="menu.notifications.without.result" />
						</span>
					</h1>
				</div>
				<!-- end col -->
							...
							<div>
								...
								<div class="widget-body">
                                    ...
                                    <form id="parameters_form" class ="smart-form">
										...
										<!-- START ROW -->
                                      	<div class="row">
                                            <section id="silais" hidden="hidden" class="col col-sm-12 col-md-6 col-lg-6">
                                                <div class="input-group">
                                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
                                            ...
                                            <section id="departamento" hidden="hidden" class="col col-sm-12 col-md-6 col-lg-6">
                                                <div class="input-group">
                                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
                                            ...
                                            <section id="municipio" hidden="hidden" class="col col-sm-12 col-md-6 col-lg-6">
                                                <div class="input-group">
                                                    <span class="input-group-addon"> <i class="fa fa-location-arrow"></i></span>
	...
	<spring:url value="/reportesPorResidencia/getDataSinResultado/" var="sActionUrl"/>
    ...
    <script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	$("li.homewithoutRes").addClass("active");
	    	if("top"!=localStorage.getItem("sm-setmenu")){
	    		$("li.homewithoutRes").parents("ul").slideDown(200);
	    	}
		});
	</script>
	<!-- END JAVASCRIPTS -->
