...
if ($.fn.validate) {
	...
	$.extend($.datepicker.regional[''], {
		validateDate: 'Por favor, introduzca una fecha válida',
		validateDateMin: 'Por favor, introduzca una fecha en o después de {0}',
		validateDateMax: 'Por favor, introduzca una fecha en o antes de {0}',
		validateDateMinMax: 'Por favor, introduzca una fecha entre {0} y {1}',
		validateDateCompare: 'Porfavor, introduzca una  fecha {0} {1}',
		validateDateToday: 'hoy',
		validateDateOther: 'la otra fecha',
		validateDateEQ: 'igual a',
		validateDateNE: 'no es equal a',
		validateDateLT: 'antes de',
		validateDateGT: 'después de',
		validateDateLE: 'no después de ',
		validateDateGE: 'no antes de'
	});
